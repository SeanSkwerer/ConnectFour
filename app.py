...
async def replay(websocket, game):
    ...
    """
    # Make a copy to avoid an exceptoin if game.moves changes while iteration
...
async def start(websocket):
    ...
    try:
        ...
        # where they will be used for building "join" and "watch" links.
        event = {
            "type": "init",
            "join": join_key,
            "watch": watch_key,
        ...
        await websocket.send(json.dumps(event))
        # Reive and process moves from the first player
